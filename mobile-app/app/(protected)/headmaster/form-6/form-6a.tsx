/**
 * Form 6A - Teaching Staff (Pre-Primary to Class 10)
 * 
 * Lists all teaching faculty who teach Pre-Primary to Class 10.
...
function FacultyCard({ faculty, expanded, onToggle, onVerify, isUpdating }: FacultyCardProps) {
    ...
    const subjectsByClass = faculty.teaching_assignments.reduce((acc, ta) => {
...
export default function Form6AScreen() {
    ...
    const submitMutation = useMutation({
        mutationFn: async () => {
            const response = await apiClient.post('/form-6/submit-6a');
            return response.data;
        },
        onSuccess: () => {
        ...
        <View style={styles.container}>
            ...
            <View style={[styles.header, { paddingTop: insets.top + 12 }]}>
                ...
                <View style={styles.headerContent}>
                    <Text style={styles.headerTitle}>Form 6A</Text>
                ...
                >
                    ...
                    <View style={styles.infoBanner}>
                        ...
                        <Text style={styles.infoBannerText}>
                            Form 6A will only list faculties who are teaching in Pre-Primary to Class 10
                        </Text>
                    </View>
                    ...
                    {facultyList && facultyList.length > 0 ? (
                        ...
                        <View style={styles.emptyContainer}>
                            ...
                            <Text style={styles.emptyText}>No teaching faculty found</Text>
                        </View>
                    )}
