...
export default function TaskDetailPage() {
    ...
    return (
        <MainLayout title="Task Details" subtitle={task.sealed_pack_code}>
            ...
            {attendance.length > 0 && (
                <div className="mb-6 bg-slate-900 border border-emerald-500/30 rounded-xl p-6">
                    <h2 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
                        📍 Officer Attendance
                        <span className="text-xs font-normal text-emerald-400 bg-emerald-500/20 px-2 py-0.5 rounded-full">
                                ...
                                {record.image_url && (
                                    ...
                                    >
                                        <img
                                            ...
                                            className="w-full h-40 object-cover rounded-lg border border-slate-600 hover:border-emerald-500 transition-colors"
                                            onError={(e) => {
