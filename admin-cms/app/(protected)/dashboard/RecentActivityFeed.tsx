...
const actionColors: Record<string, { bg: string; icon: string }> = {
    ...
    'USER_LOGOUT': { bg: 'bg-red-500/20', icon: 'text-red-400' },
    ...
    'DEVICE_ID_BOUND': { bg: 'bg-green-600/20', icon: 'text-green-300' },
    'DEVICE_ID_MISMATCH': { bg: 'bg-red-700/20', icon: 'text-red-300' },
    'FORM_SUBMITTED': { bg: 'bg-blue-400/20', icon: 'text-blue-300' },
